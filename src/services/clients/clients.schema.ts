...
export const clientsDataSchema = Type.Pick(clientsSchema, ['userId', 'cuit', 'companyName', 'condIvaTypeId', 'address'], {
  $id: 'ClientsData'
})
...
export const clientsQueryProperties = Type.Pick(clientsSchema, ['userId', 'cuit', 'companyName', 'condIvaTypeId', 'address'])
